...
class AssistantService:
    def __init__(
        self,
        backend_client: CatalogClient,
        context_manager: ConversationStore,
        ...
        self.shopping_graph_runner = shopping_graph_runner
        self.comparison_graph_runner = comparison_graph_runner
    ...
    async def compare(self, request: CompareRequest) -> ApiResponse[CompareData | None]:
        ...
        graph_result = await self.comparison_graph_runner.run(comparison_input)
        try:
